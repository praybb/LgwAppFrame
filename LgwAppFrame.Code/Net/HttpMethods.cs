...
namespace LgwAppFrame.Code
{
    ...
    public class HttpMethods
    {
        ...
        {
            return HttpPost(url, Encoding.UTF8, param);
        }
        /// <summary>
        /// HTTP POST方式请求数据
        /// </summary>
        /// <param name="url">URL</param>
        /// <param name="encoding">客户端编码</param>
        /// <param name="param">POST的数据</param>
        /// <returns></returns>
        public static string HttpPost(string url, Encoding encoding , string param = null)
        {
        ...
        {
            return HttpGet(url, Encoding.UTF8, headht);
        }
        /// <summary>
        /// HTTP GET方式请求数据.
        /// </summary>
        /// <param name="url"></param>
        /// <param name="encodeing">客户端编码方式</param>
